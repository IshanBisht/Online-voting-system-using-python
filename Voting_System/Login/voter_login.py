...
class VoterLogin:
    ...
    def open_dashboard(self, user_id):
        self.window.destroy()
        import  Voting_System.interface.UserDashboard as UserDashboard
        root = Tk()
    ...
    def redirect_window(self):
        self.window.destroy()
        import Voting_System.Registration.voter_registration as voter_registration
        root = Tk()
        obj = voter_registration.SignUp(root)
        root.mainloop()
